...
| `gh:write` | `gh_pr_create`, `gh_pr_edit`, `gh_pr_comment`, `gh_pr_edit_comment`, `gh_pr_review`, `gh_pr_add_review`, `gh_pr_reply_comment`, `gh_pr_resolve_thread`, `gh_pr_unresolve_thread`, `gh_pr_checkout`, `gh_issue_create`, `gh_issue_comment`, `gh_issue_close`, `gh_issue_edit`, `gh_run_rerun`, `gh_run_cancel`, `gh_workflow_run` | `ask` |
